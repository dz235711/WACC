...
class Translator {
  ...
  private def translateStmt(
    ...
    case Free(e) =>
      ...
      // Call free
      locationCtx.saveCallerRegisters()
      instructionCtx.addInstruction(Mov(RDI(typeToSize(e.getType)), dest))
      // TODO: clib free
      locationCtx.restoreCallerRegisters()
  ...
  private def translateRValue(value: TypedAST.RValue)(using
    ...
    case ArrayLiter(es, ty) =>
      ...
      instructionCtx.addInstruction(Mov(RDI(W32), size))
      locationCtx.saveCallerRegisters()
      // TODO: clib malloc
    ...
    case NewPair(e1, e2, PairType(t1, t2)) =>
      ...
      instructionCtx.addInstruction(Mov(RDI(W32), PAIR_SIZE))
      locationCtx.saveCallerRegisters()
      // TODO: clib malloc
      val ptr = locationCtx.setNextReg(RAX(W64))
      locationCtx.restoreCallerRegisters()
