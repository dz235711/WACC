...
class ValidBasicExitTests extends AnyFlatSpec {
  ...
  it should "frontend analyse exit-1.wacc" taggedAs Frontend in {
    frontendStatus(dir + "exit-1.wacc") shouldBe 0
  }

  it should "frontend analyse exitBasic.wacc" taggedAs Frontend in {
    frontendStatus(dir + "exitBasic.wacc") shouldBe 0
  }

  it should "frontend analyse exitBasic2.wacc" taggedAs Frontend in {
    frontendStatus(dir + "exitBasic2.wacc") shouldBe 0
  }

  it should "frontend analyse exitWrap.wacc" taggedAs Frontend in {
