...
class BackendValidIoReadTests extends AnyFlatSpec {
  ...
  it should "execute echoBigNegInt.wacc" taggedAs Backend in {
  ...
  it should "execute echoChar.wacc" taggedAs Backend in {
  ...
  it should "execute echoInt.wacc" taggedAs Backend in {
  ...
  it should "execute echoNegInt.wacc" taggedAs Backend in {
  ...
  it should "execute echoPuncChar.wacc" taggedAs Backend in {
  ...
  it should "execute read.wacc" taggedAs Backend in {
  ...
  it should "execute readAtEof.wacc" taggedAs Backend in {
