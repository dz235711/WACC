...
class BackendValidIoPrintTests extends AnyFlatSpec {
  ...
  it should "execute hashInProgram.wacc" taggedAs (Backend) in pending /*{
  ...
  it should "execute printChar.wacc" taggedAs (Backend) in pending /*{
  ...
  it should "execute printEscChar.wacc" taggedAs (Backend) in pending /*{
    fullExec(dir + "printEscChar.wacc", "") shouldBe Some("An escaped character example is "\n")
  }*/

  it should "execute printInt.wacc" taggedAs (Backend) in pending /*{
    fullExec(dir + "printInt.wacc", "") shouldBe Some("An example integer is 189\n")
  }*/

  it should "execute println.wacc" taggedAs (Backend) in pending /*{
