...
class BackendValidRuntimeerrArrayoutofboundsTests extends AnyFlatSpec {
  ...
  it should "execute arrayNegBounds.wacc" taggedAs Backend in {
  ...
  it should "execute arrayOutOfBounds.wacc" taggedAs Backend in {
  ...
  it should "execute arrayOutOfBoundsWrite.wacc" taggedAs Backend in {
