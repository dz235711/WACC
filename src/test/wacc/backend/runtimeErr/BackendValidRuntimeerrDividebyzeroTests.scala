...
class BackendValidRuntimeerrDividebyzeroTests extends AnyFlatSpec {
  ...
  it should "execute divZero.wacc" taggedAs Backend in {
  ...
  it should "execute divideByZero.wacc" taggedAs Backend in {
  ...
  it should "execute modByZero.wacc" taggedAs Backend in {
