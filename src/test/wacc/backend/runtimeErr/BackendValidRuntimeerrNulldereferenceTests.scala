...
class BackendValidRuntimeerrNulldereferenceTests extends AnyFlatSpec {
  ...
  it should "execute freeNull.wacc" taggedAs Backend in {
  ...
  it should "execute readNull1.wacc" taggedAs Backend in {
  ...
  it should "execute readNull2.wacc" taggedAs Backend in {
  ...
  it should "execute setNull1.wacc" taggedAs Backend in {
  ...
  it should "execute setNull2.wacc" taggedAs Backend in {
  ...
  it should "execute useNull1.wacc" taggedAs Backend in {
  ...
  it should "execute useNull2.wacc" taggedAs Backend in {
