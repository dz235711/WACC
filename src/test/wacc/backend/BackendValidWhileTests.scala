...
class BackendValidWhileTests extends AnyFlatSpec {
  ...
  it should "execute fibonacciFullIt.wacc" taggedAs Backend in {
  ...
  it should "execute fibonacciIterative.wacc" taggedAs Backend in {
  ...
  it should "execute min.wacc" taggedAs Backend in {
  ...
  it should "execute rmStyleAdd.wacc" taggedAs Backend in {
  ...
  it should "execute rmStyleAddIO.wacc" taggedAs Backend in {
  ...
  it should "execute whileBasic.wacc" taggedAs Backend in {
  ...
  it should "execute whileBoolFlip.wacc" taggedAs Backend in {
  ...
  it should "execute whileCount.wacc" taggedAs Backend in {
  ...
  it should "execute whileFalse.wacc" taggedAs Backend in {
