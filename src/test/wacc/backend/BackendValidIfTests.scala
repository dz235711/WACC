...
class BackendValidIfTests extends AnyFlatSpec {
  ...
  it should "execute if1.wacc" taggedAs Backend in {
  ...
  it should "execute if2.wacc" taggedAs Backend in {
  ...
  it should "execute if3.wacc" taggedAs Backend in {
  ...
  it should "execute if4.wacc" taggedAs Backend in {
  ...
  it should "execute if5.wacc" taggedAs Backend in {
  ...
  it should "execute if6.wacc" taggedAs Backend in {
  ...
  it should "execute ifBasic.wacc" taggedAs Backend in {
  ...
  it should "execute ifFalse.wacc" taggedAs Backend in {
  ...
  it should "execute ifTrue.wacc" taggedAs Backend in {
  ...
  it should "execute whitespace.wacc" taggedAs Backend in {
