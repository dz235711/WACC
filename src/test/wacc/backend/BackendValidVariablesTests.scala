...
class BackendValidVariablesTests extends AnyFlatSpec {
  ...
  it should "execute _VarNames.wacc" taggedAs Backend in {
  ...
  it should "execute boolDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute boolDeclaration2.wacc" taggedAs Backend in {
  ...
  it should "execute capCharDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute charDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute charDeclaration2.wacc" taggedAs Backend in {
  ...
  it should "execute emptyStringDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute intDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute longVarNames.wacc" taggedAs Backend in {
  ...
  it should "execute manyVariables.wacc" taggedAs Backend in {
  ...
  it should "execute negIntDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute puncCharDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute stringCarriageReturn.wacc" taggedAs Backend in {
  ...
  it should "execute stringDeclaration.wacc" taggedAs Backend in {
  ...
  it should "execute zeroIntDeclaration.wacc" taggedAs Backend in {
