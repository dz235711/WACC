...
class BackendValidFunctionSimple_functionsTests extends AnyFlatSpec {
  ...
  it should "execute functionDoubleReturn.wacc" taggedAs Backend in {
  ...
  it should "execute functionIfReturns.wacc" taggedAs Backend in {
  ...
  it should "execute functionReturnPair.wacc" taggedAs Backend in {
  ...
  it should "execute incFunction.wacc" taggedAs Backend in {
  ...
  it should "execute lotsOfLocals.wacc" taggedAs Backend in {
  ...
  it should "execute sameNameAsVar.wacc" taggedAs Backend in {
