...
class BackendValidFunctionNested_functionsTests extends AnyFlatSpec {
  ...
  it should "execute fibonacciFullRec.wacc" taggedAs Backend in {
  ...
  it should "execute fibonacciRecursive.wacc" taggedAs Backend in {
  ...
  it should "execute mutualRecursion.wacc" taggedAs Backend in {
  ...
  it should "execute printInputTriangle.wacc" taggedAs Backend in {
  ...
  it should "execute printTriangle.wacc" taggedAs Backend in {
  ...
  it should "execute simpleRecursion.wacc" taggedAs Backend in {
