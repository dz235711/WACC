...
class BackendValidBasicExitTests extends AnyFlatSpec {
  ...
  it should "correctly execute exit-1.wacc" in pending /*{
    fullExec(dir + exit-1.wacc, "") shouldBe Some("")
  }*/

  it should "correctly execute exitBasic.wacc" in pending /*{
    fullExec(dir + exitBasic.wacc, "") shouldBe Some("")
  }*/

  it should "correctly execute exitBasic2.wacc" in pending /*{
    fullExec(dir + exitBasic2.wacc, "") shouldBe Some("")
  }*/

  it should "correctly execute exitWrap.wacc" in pending /*{
