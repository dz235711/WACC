...
class ExceptionBackendTests extends AnyFlatSpec {
  ...
  it should "execute catchBadChar.wacc" taggedAs Backend in {
  ...
  it should "execute catchDivideByZero.wacc" taggedAs Backend in {
  ...
  it should "execute catchNullPairErr.wacc" taggedAs Backend in {
  ...
  it should "execute catchOutOfBounds.wacc" taggedAs Backend in {
  ...
  it should "execute catchOverflow.wacc" taggedAs Backend in {
