...
class ExceptionBackendTests extends AnyFlatSpec {
  ...
  it should "execute catchExceptionCode.wacc" taggedAs Backend in pending /*{
  ...
  it should "execute exceptionBasic.wacc" taggedAs Backend in pending /*{
  ...
  it should "execute exceptionIsNoOp.wacc" taggedAs Backend in pending /*{
