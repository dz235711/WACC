...
class ImportsTests extends AnyFlatSpec {
  ...
  it should "provide unchanged AST when importing a file without using it" taggedAs Imports in {
  ...
  it should "frontend analyse nestedImports.wacc" taggedAs Imports in {
    frontendStatus(dir + "nestedImports.wacc") shouldBe 0
  }

  // Testing whether an error is flagged for a non-existent file
  it should "flag an error for a non-existent file" taggedAs Imports in {
  ...
  it should "allow for the same file to be imported multiple times" taggedAs Imports in {
  ...
  it should "flag an error for an illegal function re-declaration when imported" taggedAs Imports in {
  ...
  it should "flag an error for an imported file with syntax errors" taggedAs Imports in {
    frontendStatus(dir + "importSyntaxError.wacc") shouldBe 100
  }

  // Testing whether an error is flagged if a file imports itself
  it should "flag an error for a file importing itself" taggedAs Imports in {
  ...
  it should "report the syntax error in the imported file" taggedAs Imports in {
